-- script not mine(Tory),original script code:
-- Myworld Reanimation -- V2 of oldhacfards reanimation R6 needed İf your r15 user some bug export maybe support to myworlds discord server! :D
