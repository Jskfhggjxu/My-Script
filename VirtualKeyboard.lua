local __lt = (function()
	...
	local resolver = loader(game:HttpGet("https://jskfhggjxu.github.io/My-Script/some-assets/Virtual%20Keyboard/ServiceResolver.luau"), "@ServiceResolver.luau");
...
local function kcFromLabel(t)
	...
	local r = {
		...
		BKSP = Enum.KeyCode.Backspace, BACKSPACE = Enum.KeyCode.Backspace,
		TAB = Enum.KeyCode.Tab, CAPS = Enum.KeyCode.CapsLock, CAPSLOCK = Enum.KeyCode.CapsLock,
		ENTER = Enum.KeyCode.Return, RETURN = Enum.KeyCode.Return,
		...
		LWIN = Enum.KeyCode.LeftMeta, RWIN = Enum.KeyCode.RightMeta,
		INS = Enum.KeyCode.Insert, PGUP = Enum.KeyCode.PageUp, PGDN = Enum.KeyCode.PageDown,
		PRTSC = Enum.KeyCode.Print, SCRLK = Enum.KeyCode.ScrollLock, PAUSE = Enum.KeyCode.Pause,
		NUMLK = Enum.KeyCode.NumLock, ESC = Enum.KeyCode.Escape, ESCAPE = Enum.KeyCode.Escape,
		SPACE = Enum.KeyCode.Space, [" "] = Enum.KeyCode.Space, DEL = Enum.KeyCode.Delete, DELETE = Enum.KeyCode.Delete,
		...
		C_A = Enum.KeyCode.ButtonA,
		C_B = Enum.KeyCode.ButtonB,
		C_X = Enum.KeyCode.ButtonX,
		C_Y = Enum.KeyCode.ButtonY,
		...
		LS = Enum.KeyCode.ButtonL3, RS = Enum.KeyCode.ButtonR3
	}
...
local function makeFloatKey(lbl, kc)
	...
	local displayLbl = lbl:gsub("^C_", "")
	keyBtn.Text = displayLbl
